    ...
    return (
        <>
            <Head>
                ...
                <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300&family=Public+Sans:wght@500;800&family=Rubik:wght@400;500&display=swap" rel="stylesheet"/>
                <link rel="preload" href="/fonts/SEGOEUI.TTF" as="font" crossOrigin=""/>
